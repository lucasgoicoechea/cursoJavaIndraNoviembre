...
public class CarritoDeLaCompraTest {
    private final int TOTAL_SIZE = (int) 20000000L;
    private final int NUMBER_ADD = (int)1000000L;
 	
    // Test con metodos tradicionales
    @Test
